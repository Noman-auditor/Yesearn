        ...
        <div className="glass-card p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">{session ? `Connected as @${session.user.username}` : "Not Connected"}</p>
            </div>
          </div>
          {session ? <CheckCircle2 className="h-6 w-6 text-green-400" /> : <Link href="/api/auth/signin"><Button size="sm">Connect X</Button></Link>}
        </div>
        <div className="glass-card p-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
