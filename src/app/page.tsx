...
import { Sparkles, Twitter, Wallet, ArrowRight, Users, Star } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/api/auth/signin">
            <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white shadow-lg shadow-blue-500/30">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          <div className="glass-card p-6 text-left">
            ...
            <p className="text-gray-400">Secure OAuth 2.0 connection to bring your social identity on-chain.</p>
          </div>
          <div className="glass-card p-6 text-left">
            <Wallet className="h-8 w-8 text-green-400 mb-4" />
            <h3 className="text-xl font-bold mb-2">Wallet Connection</h3>
            <p className="text-gray-400">Connect your EVM wallet to verify assets and build reputation.</p>
          </div>
          <div className="glass-card p-6 text-left">
            <Star className="h-8 w-8 text-yellow-400 mb-4" />
            <h3 className="text-xl font-bold mb-2">Points & Badges</h3>
            <p className="text-gray-400">Earn points for legitimate activity and unlock premium Web3 badges.</p>
          </div>
        </div>
      </div>
    </div>
